...
if question:
    ...
    with st.chat_message("assistant"):
        with st.spinner("Recherche en cours... (le premier message peut prendre jusqu'à 1 min si le serveur était en veille)"):
            try:
                # On envoie l'historique PRECEDENT (sans les sources, juste
                # role+content), en excluant la question qu'on vient d'ajouter
                # ci-dessus (deja envoyee separement dans "message").
                history_payload = [
